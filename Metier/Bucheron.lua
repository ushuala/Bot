...
function pathSelection()
    ...
    elseif (job:level(2) >= 75) and (job:level(2) < 100) then
		GATHER = {31,8,34,98,34,1,33}
        selectedPath = path3
    elseif (job:level(2) >= 100) and (job:level(2) < 140) then
		GATHER = {31,8,34,28,35,259,29,1,33,98}
    	selectedPath = path4
    elseif (job:level(2) >= 140 and job:level(2) < 200) then
		GATHER = {259,29,32,257,31,8,34,28,35,1,33,98}
    	selectedPath = path5
		elseif job:level(2) == 200 and tonumber(os.date("%M")) < 30 then
			GATHER = {259,29,32,257,31,8,34,28,35,1,33,98,30}
			selectedPath = path5
		elseif job:level(2) == 200 and tonumber(os.date("%M")) <= 60 then
			GATHER = {259,29,32,257,31,8,34,28,35,1,33,98,30}
			selectedPath = path4
		end
end
