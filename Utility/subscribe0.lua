...
unixAbo = developer:historicalMessage("IdentificationSuccessMessage")[1].subscriptionEndDate
...
function messagesRegistering()
  ...
  developer:registerMessage("IdentificationSuccessMessage", timeAbo)
end
...
function move()
  if utilityFile:isSubscribed(unixAbo) == false then
    return getApiKey()
  end
end
