...
function buyHDV()
  ...
  global:delay(1000)
  while inventory:itemCount(2551) == 0 do
  ...
  global:delay(1000)
  while inventory:itemCount(399) == 0 do
  ...
  global:delay(1000)
  while inventory:itemCount(2617) == 0 do
  ...
  global:delay(1000)
  while inventory:itemCount(2618) == 0 do
  ...
  global:delay(1000)
  while inventory:itemCount(1002) == 0 do
  ...
  global:delay(1000)
  while inventory:itemCount(8759) == 0 do
...
function otomai_3()
    ...
    npc:npc(925,3)
    global:printMessage("1")
    npc:reply(-1)
        global:printMessage("2")
    npc:reply(-1)
        global:printMessage("3")
    npc:reply(-1)
        global:printMessage("4")
        npc:reply(-1)
    map:changeMap("left")
end
...
function otomai_4()
    npc:npc(925,3)
        global:printMessage("4")
            global:delay(1000)
    npc:reply(-1)
        global:printMessage("5")
            global:delay(1000)
    npc:reply(-1)
        global:printMessage("6")
            global:delay(1000)
    npc:reply(-1)
        global:printMessage("9")
            global:delay(1000)
    npc:npc(925,3)
        global:printMessage("10")
            global:delay(1000)
    npc:reply(-1)
    global:printMessage("11")
        global:delay(1000)
npc:reply(-1)
    global:printMessage("12")
    npc:reply(-1)
            global:delay(1000)
    npc:reply(-1)
        global:delay(1000)
