global:printSuccess("--------------------------------------------------------------------------------------------------------------------------------------------")
global:printSuccess("--------------------------------------------------------------------------------------------------------------------------------------------")
global:printSuccess("---------------------------------------------- Road Creator - Version 2.1 -----------------------------------------------------")
...
RC_SAVE_MOVEMENTS 	= true 		-- true  = Enregistrer tous les mouvements que vous ayez effectué avant de changer la carte
RC_ASK_FIGHT		= true		-- true  = Demander si vous voulez faire des combats dans la carte
RC_ASK_GATHER		= true		-- true  = Demander si vous voulez faire des récoltes dans la carte
...
function _ChangeMapMessage(message)
	...
	if message.mapId == map:neighbourId("top") then
		RC_DIRECTION = "top"
	elseif message.mapId == map:neighbourId("left") then
		RC_DIRECTION = "left"
	elseif message.mapId == map:neighbourId("right") then
		RC_DIRECTION = "right"
	elseif message.mapId == map:neighbourId("bottom") then
		RC_DIRECTION = "bottom"
	else
